...
public class EsitoChiediStatoRPT  implements java.io.Serializable {
    ...
    private com.esed.easybridge.webservice.operazioni.TipoStoricoRPT[] elementoStoricoRPT;

    private com.esed.easybridge.webservice.operazioni.TipoStoricoVersamento[] elementoStoricoVersamento;
    ...
    public EsitoChiediStatoRPT(
           ...
           com.esed.easybridge.webservice.operazioni.TipoStoricoRPT[] elementoStoricoRPT,
           com.esed.easybridge.webservice.operazioni.TipoStoricoVersamento[] elementoStoricoVersamento) {
           this.stato = stato;
     ...
     */
    public com.esed.easybridge.webservice.operazioni.TipoStoricoRPT[] getElementoStoricoRPT() {
        return elementoStoricoRPT;
    }
     ...
     */
    public void setElementoStoricoRPT(com.esed.easybridge.webservice.operazioni.TipoStoricoRPT[] elementoStoricoRPT) {
        this.elementoStoricoRPT = elementoStoricoRPT;
    }

    public com.esed.easybridge.webservice.operazioni.TipoStoricoRPT getElementoStoricoRPT(int i) {
        return this.elementoStoricoRPT[i];
    }

    public void setElementoStoricoRPT(int i, com.esed.easybridge.webservice.operazioni.TipoStoricoRPT _value) {
     ...
     */
    public com.esed.easybridge.webservice.operazioni.TipoStoricoVersamento[] getElementoStoricoVersamento() {
        return elementoStoricoVersamento;
    }
     ...
     */
    public void setElementoStoricoVersamento(com.esed.easybridge.webservice.operazioni.TipoStoricoVersamento[] elementoStoricoVersamento) {
        this.elementoStoricoVersamento = elementoStoricoVersamento;
    }

    public com.esed.easybridge.webservice.operazioni.TipoStoricoVersamento getElementoStoricoVersamento(int i) {
        return this.elementoStoricoVersamento[i];
    }

    public void setElementoStoricoVersamento(int i, com.esed.easybridge.webservice.operazioni.TipoStoricoVersamento _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://operazioni.webservice.easybridge.esed.com", "esitoChiediStatoRPT"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://operazioni.webservice.easybridge.esed.com", "tipoStoricoRPT"));
        elemField.setMinOccurs(0);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://operazioni.webservice.easybridge.esed.com", "tipoStoricoVersamento"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
