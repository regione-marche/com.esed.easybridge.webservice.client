...
public class TipoListaRPTPendenti  implements java.io.Serializable {
    ...
    private com.esed.easybridge.webservice.operazioni.TipoRPTPendente[] rptPendente;
    ...
    public TipoListaRPTPendenti(
           int totRestituiti,
           com.esed.easybridge.webservice.operazioni.TipoRPTPendente[] rptPendente) {
     ...
     * @return rptPendente
     */
    public com.esed.easybridge.webservice.operazioni.TipoRPTPendente[] getRptPendente() {
        return rptPendente;
    }
     ...
     * @param rptPendente
     */
    public void setRptPendente(com.esed.easybridge.webservice.operazioni.TipoRPTPendente[] rptPendente) {
        this.rptPendente = rptPendente;
    }

    public com.esed.easybridge.webservice.operazioni.TipoRPTPendente getRptPendente(int i) {
        return this.rptPendente[i];
    }

    public void setRptPendente(int i, com.esed.easybridge.webservice.operazioni.TipoRPTPendente _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://operazioni.webservice.easybridge.esed.com", "tipoListaRPTPendenti"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://operazioni.webservice.easybridge.esed.com", "tipoRPTPendente"));
